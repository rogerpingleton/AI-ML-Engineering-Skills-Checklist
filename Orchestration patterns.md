# Orchestration Patterns in AI Engineering

> A practical guide to multi-agent coordination strategies, with Python examples.

---

## Table of Contents

1. [What Is Orchestration in AI Engineering?](#what-is-orchestration)
2. [Why Orchestration Patterns Matter](#why-they-matter)
3. [Complexity Spectrum: When to Orchestrate](#complexity-spectrum)
4. [Core Orchestration Patterns](#core-patterns)
    - [Sequential (Pipeline)](#1-sequential-pipeline)
    - [Concurrent (Fan-out / Fan-in)](#2-concurrent-fan-outfan-in)
    - [Hierarchical (Orchestrator–Subagent)](#3-hierarchical-orchestratorsubagent)
    - [Maker–Checker (Generator–Critic)](#4-makerchecker-generatorcritic)
    - [Router (Dynamic Dispatch)](#5-router-dynamic-dispatch)
    - [Human-in-the-Loop (HITL)](#6-human-in-the-loop-hitl)
5. [Pattern Comparison](#pattern-comparison)
6. [Key Frameworks in 2025–2026](#key-frameworks)
