# Batch vs. Online Inference Strategies in AI Engineering
...
1. [Overview: The Inference Optimization Problem](#1-overview)
2. [Core Concepts: What Makes Inference Hard](#2-core-concepts)
3. [The Fundamental Axis: Batch vs. Online Inference](#3-the-fundamental-axis)
4. [Batching Strategies in Depth](#4-batching-strategies-in-depth)
    - 4.1 Static Batching
    - 4.2 Dynamic Batching
    - 4.3 Continuous Batching (In-Flight Batching)
5. [Online Inference Strategies](#5-online-inference-strategies)
6. [Streaming Inference](#6-streaming-inference)
7. [Key Performance Metrics](#7-key-performance-metrics)
8. [The Latency–Throughput Tradeoff](#8-the-latency-throughput-tradeoff)
9. [GPU Memory & the KV Cache](#9-gpu-memory--the-kv-cache)
10. [Complementary Techniques](#10-complementary-techniques)
11. [Tooling & Frameworks](#11-tooling--frameworks)
12. [Decision Framework: Choosing the Right Strategy](#12-decision-framework)
13. [Python Code Examples](#13-python-code-examples)
14. [Subtle Nuances & Common Pitfalls](#14-subtle-nuances--common-pitfalls)
