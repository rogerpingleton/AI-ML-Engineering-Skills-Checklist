...
### A Comprehensive AI Engineering Reference (2025)
...
2. [The Retrieval Pipeline: A Mental Model](#the-retrieval-pipeline)
3. [Technique 1: Chunking Strategies](#1-chunking-strategies)
4. [Technique 2: Embedding Model Selection & Fine-Tuning](#2-embedding-model-selection--fine-tuning)
5. [Technique 3: Hybrid Search (Dense + Sparse)](#3-hybrid-search-dense--sparse)
6. [Technique 4: Query Transformation Techniques](#4-query-transformation-techniques)
7. [Technique 5: Reranking (Two-Stage Retrieval)](#5-reranking-two-stage-retrieval)
8. [Technique 6: Metadata Filtering](#6-metadata-filtering)
9. [Technique 7: Parent-Document & Hierarchical Retrieval](#7-parent-document--hierarchical-retrieval)
10. [Technique 8: Contextual Retrieval](#8-contextual-retrieval)
11. [Technique 9: Graph-Based Retrieval (GraphRAG)](#9-graph-based-retrieval-graphrag)
12. [Technique 10: Adaptive & Corrective RAG](#10-adaptive--corrective-rag)
13. [Technique 11: Context Compression & Distillation](#11-context-compression--distillation)
14. [Technique 12: Reciprocal Rank Fusion (RRF)](#12-reciprocal-rank-fusion-rrf)
15. [Technique 13: Approximate Nearest Neighbor (ANN) Indexing](#13-approximate-nearest-neighbor-ann-indexing)
16. [Technique 14: Feedback Loops & Continuous Improvement](#14-feedback-loops--continuous-improvement)
17. [Putting It All Together: A Production Pipeline](#putting-it-all-together)
