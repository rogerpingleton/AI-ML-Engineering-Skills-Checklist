...
1. [Why Linear Algebra Matters in AI Engineering](#why-linear-algebra-matters)
2. [Scalars, Vectors, and Matrices](#scalars-vectors-and-matrices)
3. [Matrix Operations](#matrix-operations)
4. [The Dot Product and Similarity](#the-dot-product-and-similarity)
5. [Matrix Multiplication](#matrix-multiplication)
6. [Tensors](#tensors)
7. [Linear Transformations](#linear-transformations)
8. [Norms and Distance](#norms-and-distance)
9. [Eigenvalues and Eigenvectors](#eigenvalues-and-eigenvectors)
10. [Singular Value Decomposition (SVD)](#singular-value-decomposition)
11. [Projections and Orthogonality](#projections-and-orthogonality)
12. [Working with NumPy and PyTorch](#working-with-numpy-and-pytorch)
