...
1. [What Is Model Routing?](#1-what-is-model-routing)
2. [What Is an LLM Gateway?](#2-what-is-an-llm-gateway)
...
6. [Python Examples](#6-python-examples)
    - 6.1 [Basic Multi-Provider Routing with LiteLLM](#61-basic-multi-provider-routing-with-litellm)
    - 6.2 [Complexity-Based Routing (Strong vs. Weak Model)](#62-complexity-based-routing-strong-vs-weak-model)
    - 6.3 [Latency-Based Routing with Fallback](#63-latency-based-routing-with-fallback)
    - 6.4 [Task-Type Semantic Routing](#64-task-type-semantic-routing)
    - 6.5 [Cost-Aware Routing with Budget Controls](#65-cost-aware-routing-with-budget-controls)
    - 6.6 [Building a Custom Gateway Wrapper](#66-building-a-custom-gateway-wrapper)
7. [Gateway Tool Comparison (2025)](#7-gateway-tool-comparison-2025)
8. [Architecture Patterns](#8-architecture-patterns)
9. [Decision Guide: Choosing the Right Approach](#9-decision-guide-choosing-the-right-approach)
