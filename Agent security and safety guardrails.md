# Agentic AI Security & Safety Guardrails

### A Comprehensive Reference for AI Engineers
...
1. [The Agentic Security Paradigm Shift](#1-the-agentic-security-paradigm-shift)
2. [Threat Landscape: What Can Go Wrong](#2-threat-landscape-what-can-go-wrong)
...
3. [The Guardrail Architecture: A Defense-in-Depth Model](#3-the-guardrail-architecture-a-defense-in-depth-model)
4. [Layer 1 — Identity & Access Control](#4-layer-1--identity--access-control)
5. [Layer 2 — Input & Output Filtering](#5-layer-2--input--output-filtering)
6. [Layer 3 — Tool & Action Governance](#6-layer-3--tool--action-governance)
7. [Layer 4 — Human-in-the-Loop (HITL)](#7-layer-4--human-in-the-loop-hitl)
8. [Layer 5 — Observability & Audit Logging](#8-layer-5--observability--audit-logging)
9. [Layer 6 — Isolation & Sandboxing](#9-layer-6--isolation--sandboxing)
10. [Governance Frameworks: OWASP, NIST, AEGIS, MAESTRO](#10-governance-frameworks-owasp-nist-aegis-maestro)
...
13. [Emerging Threats & What's Next](#13-emerging-threats--whats-next)
...
| Source                                                                                                                         | Relevance                                                     |
| ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| [OWASP Top 10 for LLM Applications 2025](https://owasp.org/www-project-top-10-for-large-language-model-applications/)          | Primary operational reference for LLM/agent risks             |
| [NIST AI RMF + NIST.AI.600-1](https://airc.nist.gov/Docs/1)                                                                    | Government-grade risk management framework                    |
| [Forrester AEGIS Framework (2025)](https://bigid.com/blog/what-is-aegis/)                                                      | Six-domain governance model for agentic AI                    |
| [OpenAI: Designing Agents to Resist Prompt Injection](https://openai.com/index/designing-agents-to-resist-prompt-injection/)   | First-principles analysis of injection + social engineering   |
| [LangGraph HITL Documentation](https://docs.langchain.com/oss/python/langchain/human-in-the-loop)                              | Primary implementation reference for Python HITL              |
| [ISO/IEC 42001 & 23894](https://www.iso.org/standard/81230.html)                                                               | International AI management system standards                  |
| [Lakera: Indirect Prompt Injection](https://www.lakera.ai/blog/indirect-prompt-injection)                                      | Deep technical analysis of IPI attacks                        |
| [Superagent Framework](https://www.helpnetsecurity.com/2025/12/29/superagent-framework-guardrails-agentic-ai/)                 | Open-source guardrails framework                              |
| [NSA Cybersecurity Advisories on AI Deployment (2024–2025)](https://www.nsa.gov/Press-Room/Cybersecurity-Advisories-Guidance/) | Government baseline for identity, monitoring, data protection |
| [MAESTRO Threat Modeling for Agentic AI](https://owasp.org/www-project-genai-security/)                                        | Structured threat modeling framework for agents               |
| [Cloud Security Alliance: Agentic AI Red Teaming Guide](https://cloudsecurityalliance.org/)                                    | Red teaming playbook for autonomous AI                        |