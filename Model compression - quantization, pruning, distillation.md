# Model Compression for Inference Optimization

### An AI Engineering Reference Guide

> _April 2026 — Covering quantization, pruning, distillation, and beyond_

---

## Table of Contents

1. [Why Model Compression Matters](#1-why-model-compression-matters)
...
6. [Hybrid Pipelines](#6-hybrid-pipelines)
7. [What You Need to Know When Working with Compressed Models](#7-what-you-need-to-know-when-working-with-compressed-models)
8. [Python Tooling Cheatsheet](#8-python-tooling-cheatsheet)
9. [Technique Comparison Summary](#9-technique-comparison-summary)
...
- [A Survey of Model Compression Techniques: Past, Present, and Future](https://www.frontiersin.org/journals/robotics-and-ai/articles/10.3389/frobt.2025.1518965/full) — Frontiers in Robotics & AI, March 2025
- [A Survey on Model Compression for Large Language Models](https://direct.mit.edu/tacl/article/doi/10.1162/tacl_a_00704/125482/) — TACL / MIT Press
- [A Review of State-of-the-Art Techniques for LLM Compression](https://link.springer.com/article/10.1007/s40747-025-02019-z) — Complex & Intelligent Systems, Springer, 2025
- [Top 5 AI Model Optimization Techniques — NVIDIA Technical Blog](https://developer.nvidia.com/blog/top-5-ai-model-optimization-techniques-for-faster-smarter-inference/)
- [LLM Compression and Optimization — Red Hat Blog](https://www.redhat.com/en/blog/llm-compression-and-optimization-cheaper-inference-fewer-hardware-resources)
- [Model Compression: Make Your ML Models Lighter and Faster — Towards Data Science](https://towardsdatascience.com/model-compression-make-your-machine-learning-models-lighter-and-faster/)
...
- [HuggingFace LLM Compressor](https://github.com/vllm-project/llm-compressor)
