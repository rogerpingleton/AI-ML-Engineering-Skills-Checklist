# Testing in AI Engineering: A Software Engineering Perspective
...
You'll be expected to know frameworks like **[Braintrust](https://braintrustdata.com/)**, **[LangSmith](https://smith.langchain.com/)**, **[Ragas](https://docs.ragas.io/)** (for RAG evaluation), or **[Promptfoo](https://promptfoo.dev/)** for structured eval pipelines.
