# Deep Learning: A Comprehensive Guide for AI Engineers

---

![[deep_learning_landscape.svg|697]]
...
3. [The Neuron and the Neural Network](#3-the-neuron-and-the-neural-network)
4. [Backpropagation and Gradient Descent](#4-backpropagation-and-gradient-descent)
...
9. [Core Architectures](#9-core-architectures)
...
10. [Training Deep Networks in Practice](#10-training-deep-networks-in-practice)
11. [Transfer Learning and Fine-Tuning](#11-transfer-learning-and-fine-tuning)
12. [Applied Domains](#12-applied-domains)
13. [Model Deployment and Production](#13-model-deployment-and-production)
14. [Model Compression](#14-model-compression)
15. [Python Tools and Ecosystem](#15-python-tools-and-ecosystem)
16. [What AI Engineers Are Expected to Know](#16-what-ai-engineers-are-expected-to-know)
