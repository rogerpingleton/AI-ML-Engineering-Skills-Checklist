# Docker, Docker Compose & Containers for AI Engineers

### A Comprehensive Field Guide — April 2026

---

## Table of Contents

1. [Why Docker Matters for AI Engineering](#1-why-docker-matters-for-ai-engineering)
2. [Core Concepts: Containers, Images, and Registries](#2-core-concepts-containers-images-and-registries)
3. [Dockerfile Fundamentals](#3-dockerfile-fundamentals)
4. [Essential Docker CLI Commands](#4-essential-docker-cli-commands)
5. [Docker Compose: Multi-Service AI Stacks](#5-docker-compose-multi-service-ai-stacks)
6. [GPU Support for AI/ML Workloads](#6-gpu-support-for-aiml-workloads)
7. [Deploying AI Applications to Production](#7-deploying-ai-applications-to-production)
8. [Kubernetes: Orchestration at Scale](#8-kubernetes-orchestration-at-scale)
9. [CI/CD Pipelines for AI Models](#9-cicd-pipelines-for-ai-models)
