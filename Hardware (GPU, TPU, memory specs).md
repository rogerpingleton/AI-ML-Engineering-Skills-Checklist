# Hardware & AI Inference Optimization
...
1. [The Fundamental Nature of Inference: Memory-Bound, Not Compute-Bound](#1-the-fundamental-nature-of-inference)
2. [The Two Phases of LLM Inference](#2-the-two-phases-of-llm-inference)
3. [GPU Architecture & Inference](#3-gpu-architecture--inference)
4. [TPU Architecture & Why It Matters Now](#4-tpu-architecture--why-it-matters-now)
5. [Other Hardware Accelerators](#5-other-hardware-accelerators)
6. [Memory: The True Bottleneck](#6-memory-the-true-bottleneck)
7. [KV Cache: The Central Challenge](#7-kv-cache-the-central-challenge)
8. [Parallelism Strategies for Multi-GPU/Multi-Chip Inference](#8-parallelism-strategies)
9. [Key Optimization Techniques](#9-key-optimization-techniques)
10. [Inference Serving Frameworks](#10-inference-serving-frameworks)
11. [Hardware Selection Decision Guide](#11-hardware-selection-decision-guide)
12. [Metrics That Matter](#12-metrics-that-matter)
13. [The Evolving Landscape (2025–2026)](#13-the-evolving-landscape-20252026)
