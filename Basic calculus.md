# Calculus for AI Engineers

### A Practical Technical Reference

---

## Table of Contents

1. [Why Calculus Matters in AI Engineering](#1-why-calculus-matters)
2. [Foundational Prerequisites](#2-foundational-prerequisites)
3. [Functions and Their Behavior](#3-functions-and-their-behavior)
4. [Derivatives: The Core Tool](#4-derivatives-the-core-tool)
5. [Key Differentiation Rules](#5-key-differentiation-rules)
6. [Partial Derivatives and Multivariable Calculus](#6-partial-derivatives-and-multivariable-calculus)
7. [Gradients](#7-gradients)
8. [The Chain Rule](#8-the-chain-rule)
9. [Gradient Descent: Calculus in Action](#9-gradient-descent-calculus-in-action)
10. [Backpropagation: The Chain Rule at Scale](#10-backpropagation-the-chain-rule-at-scale)
11. [Loss Functions and Their Derivatives](#11-loss-functions-and-their-derivatives)
12. [Activation Functions and Their Derivatives](#12-activation-functions-and-their-derivatives)
13. [Integrals: Where They Show Up](#13-integrals-where-they-show-up)
14. [Jacobian and Hessian Matrices](#14-jacobian-and-hessian-matrices)
15. [Practical Python Examples](#15-practical-python-examples)
16. [Summary: The AI Engineer's Calculus Cheatsheet](#16-summary-cheatsheet)
