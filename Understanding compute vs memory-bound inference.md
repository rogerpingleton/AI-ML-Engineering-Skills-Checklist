# Compute vs Memory-Bound Inference in AI Engineering

### A Technical Report on Inference Optimization for Large Language Models
...
3. [The Two Inference Phases: Prefill and Decode](#3-the-two-inference-phases-prefill-and-decode)
4. [The Roofline Model: Diagnosing Your Bottleneck](#4-the-roofline-model-diagnosing-your-bottleneck)
5. [Decision Criteria: Choosing the Right Optimization Strategy](#5-decision-criteria-choosing-the-right-optimization-strategy)
6. [Optimizing Memory-Bound Inference](#6-optimizing-memory-bound-inference)
7. [Optimizing Compute-Bound Inference](#7-optimizing-compute-bound-inference)
8. [Python Implementation Examples](#8-python-implementation-examples)
9. [Metrics and Monitoring](#9-metrics-and-monitoring)
10. [Summary Decision Framework](#10-summary-decision-framework)
