# Statistics & Probability for AI Engineers

---

![[stats_probability_ai_engineering_map.svg|697]]
...
1. [Why Statistics Matters in AI Engineering](#1-why-statistics-matters-in-ai-engineering)
...
5. [Bayesian Thinking](#5-bayesian-thinking)
6. [Statistical Inference & Hypothesis Testing](#6-statistical-inference--hypothesis-testing)
7. [Correlation, Covariance & Dependence](#7-correlation-covariance--dependence)
8. [Information Theory](#8-information-theory)
9. [Sampling & the Law of Large Numbers](#9-sampling--the-law-large-numbers)
10. [Statistical Evaluation of Models](#10-statistical-evaluation-of-models)
11. [Working with Distributions in Python](#11-working-with-distributions-in-python)
