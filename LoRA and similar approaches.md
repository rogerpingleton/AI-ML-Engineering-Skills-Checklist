# LoRA, QLoRA, and Parameter-Efficient Fine-Tuning: A Comprehensive AI Engineering Guide

**Date:** April 2026  
**Topic:** PEFT Techniques — LoRA, QLoRA, and Variants  
**Audience:** AI/ML Engineers and Technical Practitioners

---

## Table of Contents

1. [Background: Why Fine-Tuning Matters](#1-background-why-fine-tuning-matters)
2. [The PEFT Landscape](#2-the-peft-landscape)
3. [LoRA: Low-Rank Adaptation — The Math and Mechanics](#3-lora-low-rank-adaptation--the-math-and-mechanics)
4. [QLoRA: Quantized LoRA](#4-qlora-quantized-lora)
5. [The LoRA Variant Ecosystem (2025–2026)](#5-the-lora-variant-ecosystem-20252026)
6. [Where Do LoRA Adapters Live?](#6-where-do-lora-adapters-live)
7. [Integration with Commercial LLMs](#7-integration-with-commercial-llms)
8. [Training a LoRA: A Practical Walkthrough](#8-training-a-lora-a-practical-walkthrough)
9. [Key Hyperparameters and Tuning Guidance](#9-key-hyperparameters-and-tuning-guidance)
10. [When Should You Train a LoRA?](#10-when-should-you-train-a-lora)
11. [Real-World Use Case Examples](#11-real-world-use-case-examples)
12. [Serving LoRA Adapters in Production](#12-serving-lora-adapters-in-production)
13. [Cost Considerations](#13-cost-considerations)
14. [Common Pitfalls and How to Avoid Them](#14-common-pitfalls-and-how-to-avoid-them)
15. [Summary and Decision Framework](#15-summary-and-decision-framework)
