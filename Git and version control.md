# Git Commands Every AI Engineer Needs to Know
...
11. [Git Worktrees](#11-git-worktrees)
12. [Submodules](#12-submodules)
13. [Large File Storage (Git LFS)](#13-large-file-storage-git-lfs)
14. [.gitignore & .gitattributes](#14-gitignore--gitattributes)
15. [Advanced: Bisect, Cherry-Pick, Reflog](#15-advanced-bisect-cherry-pick-reflog)
16. [GitHub in a CI/CD Environment](#16-github-in-a-cicd-environment)
