# AI Engineering: Evaluation Metrics & Testing
...
2. [Taxonomy of Evaluation Metrics](#2-taxonomy-of-evaluation-metrics)
3. [Perplexity](#3-perplexity)
4. [BLEU](#4-bleu-bilingual-evaluation-understudy)
5. [ROUGE](#5-rouge-recall-oriented-understudy-for-gisting-evaluation)
6. [METEOR](#6-meteor)
7. [BERTScore](#7-bertscore)
8. [Semantic Similarity](#8-semantic-similarity)
9. [Functional Correctness (pass@k / HumanEval)](#9-functional-correctness-passk--humaneval)
10. [Modern & Specialized Metrics](#10-modern--specialized-metrics)
11. [Evaluation Frameworks](#11-evaluation-frameworks)
12. [Choosing the Right Metric](#12-choosing-the-right-metric)
